...
const User = props => {
  return __jsx("div", {
    ...
    id: "4132663939"
  }, ["div.jsx-4132663939{border:1px solid #eee;box-shadow:0 2px 3px #ccc;padding:20px;text-align:center;}"]));
};
...
const AuthIndexPage = props => {
  return auth_jsx("div", null, auth_jsx("h1", null, "The Auth Index Page of ", props.appName), auth_jsx(components_User, {
    name: "Elliot",
    age: 500
  }));
};
